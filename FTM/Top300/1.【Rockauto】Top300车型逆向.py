"""
Filename:1.【Rockauto】Top300车型逆向.py
Author: Westbroobo
Date: 2024/8/27
"""
...
Type_Code = '1001628' # 修改为对应品类type_code
cursor = conn.cursor()
sql = '''
...
columns_ls = ['Model_US', 'Make', 'Model', 'Year', 'Describtion',  'Picture', 'Brand',
              'Part_Number', 'OE_Numbers', 'Engine', 'Note_1', 'Note_2', 'OE来源']
...
wb.save('1.【Rockauto】Top300车型逆向.xlsx')
