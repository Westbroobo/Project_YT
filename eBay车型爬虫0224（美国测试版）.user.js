// ==UserScript==
// @name         eBay车型爬虫0224（美国测试版）
// @namespace    http://tampermonkey.net/
// @version      24.06.29
// @description  提取车型表整理成make+model+year形式（仅限美国eBay）
// @author       Westbroobo
    ...
    function processdata(xhr) {
        ...
        rows.forEach(row => {
            ...
            if (vehicle_data.Year.length === vehicle_number) {
                ...
                document.querySelector(".motors-compatibility-table-wrapper").insertAdjacentHTML("beforebegin", tablehtml2);
            };
        })
    }
